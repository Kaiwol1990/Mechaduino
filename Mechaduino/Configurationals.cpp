...
const int uMAX = ((512.0 * iMAX * 10 * rSense) / (1000 * 3.3)); // max voltage for the vref pins
...
const int stepangle = ((100 * 36000.0 / (steps_per_revolution * 512))); // angle of one step as int
...
char step_add = 512 / microstepping;
